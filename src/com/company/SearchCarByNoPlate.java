 ...
 * @author Faran Ahmed
 */
public class SearchCarByNoPlate extends javax.swing.JFrame implements ActionListener {

    /**
     * Creates new form SearchCarByNoPlate
     */
    public SearchCarByNoPlate() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Search Car by No Plate");

        jLabel3.setText("Enter No Plate of the Car you want to search");
    ...
    public void actionPerformed(ActionEvent e) {
        int searchPlateNo=Integer.parseInt(jTextField1.getText());
        if(e.getActionCommand().equals("Submit")){
            Car.searchCarbyNoPlate(searchPlateNo);
