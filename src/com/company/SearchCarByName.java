 ...
 * @author Faran Ahmed
 */
public class SearchCarByName extends javax.swing.JFrame implements ActionListener {

    /**
     * Creates new form SearchCarByName
     */
    public SearchCarByName() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Search Car by Name");

        jLabel3.setText("Enter Name of the Car you want to search");
    ...
    public void actionPerformed(ActionEvent e) {
        searchName = jTextField1.getText().trim();
        if (e.getActionCommand().equals("Submit")) {
            Car.searchCarbyName(searchName);
