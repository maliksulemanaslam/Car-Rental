 ...
 * @author Faran Ahmed
 */
public class sign_in_Cust extends javax.swing.JFrame implements ActionListener {
    ...
    public static String Fname,Lname,DOB,email,pass,ID;

    @Override
    public void actionPerformed(ActionEvent e) {
        Fname=  jTextField1.getText().trim();
        Lname= jTextField2.getText().trim();
        DOB= jTextField3.getText().trim();
        email= jTextField4.getText().trim();
        pass= jPasswordField.getText().trim();
        ID = jTextField6.getText();
        if(e.getActionCommand().equals("Sign up"))
        {
            Member.MemberReg(Fname, Lname, DOB, email, pass, ID);
            this.setVisible(false);
            java.awt.EventQueue.invokeLater(new Runnable() {
                public void run() {
                    new RegisterMemberAddMsg().setVisible(true);
                }
            });
        }
    }
